...
<div class="col-sm-6 p-r-15-sr991 p-b-5">
	<div class="how2 how2-cl2 flex-sb-c m-b-35">
		<h3 class="fs-22 cl13 tab01-title">	अर्थ / वाणिज्य</h3>
	</div>
		<?php 
			$financeNews_first = new WP_Query(array(
				'posts_per_page' => 1,
				'category_name' => 'अर्थ-वाणिज्य',
			));
			$financeNews_rest = new WP_Query(array(
				'posts_per_page' => 3,
				'category_name' => 'अर्थ-वाणिज्य',
				'offset' => 1,
			));
			if($financeNews_first->have_posts()) {
				while($financeNews_first->have_posts()) {
					$financeNews_first->the_post(); $financeNews_first-> gt_set_post_view(); ?>
						<!-- Main Item post -->	
						<div class="m-b-30">
		...
		?>
		<?php
			while($financeNews_rest->have_posts()) {
				$financeNews_rest->the_post(); $financeNews_rest-> gt_set_post_view(); ?>
				<!-- Item post -->	
